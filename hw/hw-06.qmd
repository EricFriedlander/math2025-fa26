...
-   Go to [RStudio]({{< var rstudio_url >}}) and login with your College of Idaho Email and Password.

-   Make a subfolder in your `hw` directory to store this homework.

-   Log into [Canvas](https://cofi.instructure.com/courses/CANVAS_ID_TBD), navigate to Homework 6 and upload the `hw-06.qmd` file into the folder you just made.
...
Choose one of the coefficients from your model and write out all the steps in the hypothesis test that corresponds to it's p-value as in [this slide](/slides/15-mlr-inference.html#mlr-hypothesis-test-treatment).
