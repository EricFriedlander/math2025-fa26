...
-   Log into [Canvas](https://cofi.instructure.com/courses/18743), navigate to Homework 3 and upload the `hw-03.qmd` and `coffee-grades.csv` file into the folder you just made.
