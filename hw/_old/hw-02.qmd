...
-   Log into [Canvas](https://cofi.instructure.com/courses/18743), navigate to Homework 2 and upload the `hw-02.qmd` and `us-counties-sample.csv` files into the folder you just made.
