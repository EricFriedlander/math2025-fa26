...
-   Log into [Canvas](https://cofi.instructure.com/courses/18743), navigate to Homework 4 and upload the `hw-04.qmd` and `alumni-salaries.csv` file into the folder you just made.
