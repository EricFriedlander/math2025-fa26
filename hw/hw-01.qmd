...
-   Log into [Canvas](https://cofi.instructure.com/courses/CANVAS_ID_TBD/assignments/202858), navigate to HW-01 and upload the `hw-01.qmd` and `parks.csv` file into the folder your just made. The previous link should take you right to the assignment.
