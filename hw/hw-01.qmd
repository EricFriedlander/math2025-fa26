...
-   Log into [Canvas](https://cofi.instructure.com/courses/CANVAS_ID_TBD), navigate to HW-01 and upload the `hw-01.qmd` and `parks.csv` file into the folder you just made.
