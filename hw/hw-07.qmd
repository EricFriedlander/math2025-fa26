...
-   Log into [Canvas](https://cofi.instructure.com/courses/CANVAS_ID_TBD), navigate to Homework 7 and upload the `hw-07.qmd` and `lego-sample.csv` files into the folder you just made.
