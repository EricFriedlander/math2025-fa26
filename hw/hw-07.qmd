...
-   Log into [Canvas](https://cofi.instructure.com/courses/CANVAS_ID_TBD/assignments/202866), navigate to Homework 8 and upload the `hw-08.qmd` and `lego-sample.csv` files into the folder your just made.
