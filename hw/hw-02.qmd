...
-   Log into [Canvas](https://cofi.instructure.com/courses/CANVAS_ID_TBD/assignments/202860), navigate to Homework 2 and upload the `hw-02.qmd` and `us-counties-sample.csv` files into the folder your just made.
