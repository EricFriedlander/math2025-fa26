...
-   Log into [Canvas](https://cofi.instructure.com/courses/CANVAS_ID_TBD), navigate to Homework 4 and upload the `hw-04.qmd` and `alumni-salaries.csv` file into the folder you just made.
