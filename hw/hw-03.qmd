...
-   Log into [Canvas](https://cofi.instructure.com/courses/CANVAS_ID_TBD), navigate to Homework 3 and upload the `hw-03.qmd` and `coffee-grades.csv` file into the folder you just made.
