...
::: callout-important
-   Open [RStudio]({{< var rstudio_url >}}) and create a subfolder in your AE folder called "AE-17".

-   Go to the [Canvas](https://cofi.instructure.com/courses/CANVAS_ID_TBD) and locate your `AE-17` assignment to get started.
