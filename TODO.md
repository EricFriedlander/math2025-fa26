...
### FA26 due-date table (as entered in `index.qmd` / project pages)
...
- [ ] Confirm the exact Dec 7-10 final-exam slot for our MW 10:50am section with the registrar, then replace the "exact slot TBD" placeholder in `index.qmd` and `project/project-final.qmd` / `project/project-poster.qmd`.
